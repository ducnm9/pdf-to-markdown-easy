...
Every project goes through this process. A todo list, a single-function utility, a config change — all of them. The design can be short for truly simple projects, but you MUST present it and get approval.
...
8. **Transition to implementation** — use `#superpowers-writing-plans` to create implementation plan
